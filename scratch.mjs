...
// 2. handling function for the event request

// Use the carosel functions , pass in image source, alternative image, image id
// might need to do a for each loop to loop over the date


// make interceptor- check other page coding to see interceptor
// if doing html, will need to defer the script tags
// cdn has to go into the html
